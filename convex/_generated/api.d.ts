  ...
  betterAuth: {
    lib: {
      create: FunctionReference<
        ...
        any
      >
      deleteAllForUser: FunctionReference<'action', 'internal', { table: string; userId: string }, any>
      ...
      deleteBy: FunctionReference<
        ...
        any
      >
      deleteOldVerifications: FunctionReference<'action', 'internal', { currentTimestamp: number }, any>
      ...
      getAccountByAccountIdAndProviderId: FunctionReference<
        ...
        any
      >
      getAccountsByUserId: FunctionReference<'query', 'internal', { limit?: number; userId: string }, any>
